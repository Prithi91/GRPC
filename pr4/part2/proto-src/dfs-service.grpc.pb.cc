...
static const char* DFSService_method_names[] = {
  ...
  "/dfs_service.DFSService/AcquireLock",
};
...
DFSService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_AcquireLock_(DFSService_method_names[4], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}

::grpc::ClientWriter< ::dfs_service::Request>* DFSService::Stub::StoreFileRaw(::grpc::ClientContext* context, ::dfs_service::Empty* response) {
  return ::grpc::internal::ClientWriterFactory< ::dfs_service::Request>::Create(channel_.get(), rpcmethod_StoreFile_, context, response);
}

void DFSService::Stub::experimental_async::StoreFile(::grpc::ClientContext* context, ::dfs_service::Empty* response, ::grpc::experimental::ClientWriteReactor< ::dfs_service::Request>* reactor) {
  ::grpc::internal::ClientCallbackWriterFactory< ::dfs_service::Request>::Create(stub_->channel_.get(), stub_->rpcmethod_StoreFile_, context, response, reactor);
}

::grpc::ClientAsyncWriter< ::dfs_service::Request>* DFSService::Stub::AsyncStoreFileRaw(::grpc::ClientContext* context, ::dfs_service::Empty* response, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc::internal::ClientAsyncWriterFactory< ::dfs_service::Request>::Create(channel_.get(), cq, rpcmethod_StoreFile_, context, response, true, tag);
}

::grpc::ClientAsyncWriter< ::dfs_service::Request>* DFSService::Stub::PrepareAsyncStoreFileRaw(::grpc::ClientContext* context, ::dfs_service::Empty* response, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncWriterFactory< ::dfs_service::Request>::Create(channel_.get(), cq, rpcmethod_StoreFile_, context, response, false, nullptr);
}
...
::grpc::Status DFSService::Stub::AcquireLock(::grpc::ClientContext* context, const ::dfs_service::Request& request, ::dfs_service::Empty* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_AcquireLock_, context, request, response);
}

void DFSService::Stub::experimental_async::AcquireLock(::grpc::ClientContext* context, const ::dfs_service::Request* request, ::dfs_service::Empty* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_AcquireLock_, context, request, response, std::move(f));
}

void DFSService::Stub::experimental_async::AcquireLock(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::dfs_service::Empty* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_AcquireLock_, context, request, response, std::move(f));
}

void DFSService::Stub::experimental_async::AcquireLock(::grpc::ClientContext* context, const ::dfs_service::Request* request, ::dfs_service::Empty* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_AcquireLock_, context, request, response, reactor);
}

void DFSService::Stub::experimental_async::AcquireLock(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::dfs_service::Empty* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_AcquireLock_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::dfs_service::Empty>* DFSService::Stub::AsyncAcquireLockRaw(::grpc::ClientContext* context, const ::dfs_service::Request& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::dfs_service::Empty>::Create(channel_.get(), cq, rpcmethod_AcquireLock_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::dfs_service::Empty>* DFSService::Stub::PrepareAsyncAcquireLockRaw(::grpc::ClientContext* context, const ::dfs_service::Request& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::dfs_service::Empty>::Create(channel_.get(), cq, rpcmethod_AcquireLock_, context, request, false);
}
...
DFSService::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::ClientStreamingHandler< DFSService::Service, ::dfs_service::Request, ::dfs_service::Empty>(
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< DFSService::Service, ::dfs_service::Request, ::dfs_service::Empty>(
          std::mem_fn(&DFSService::Service::AcquireLock), this)));
}

DFSService::Service::~Service() {
}

::grpc::Status DFSService::Service::StoreFile(::grpc::ServerContext* context, ::grpc::ServerReader< ::dfs_service::Request>* reader, ::dfs_service::Empty* response) {
  (void) context;
  (void) reader;
  (void) response;
...
::grpc::Status DFSService::Service::AcquireLock(::grpc::ServerContext* context, const ::dfs_service::Request* request, ::dfs_service::Empty* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
